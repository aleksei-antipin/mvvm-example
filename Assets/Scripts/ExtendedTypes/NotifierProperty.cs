...
namespace DM.NotifierTypes
{
	...
	public interface INotifierPropertyReadonly< T >
	{
		#region Properties
		T Value { get; }
		#endregion
	...
	public class NotifierProperty< T > : INotifierProperty< T >, INotifierPropertyReadonly< T >
	{
		...
		#region Constructors
		public NotifierProperty( TypeDispatchEventMode dispatchEventMode = TypeDispatchEventMode.ValueChange )
		{
		...
		public NotifierProperty( T value, TypeDispatchEventMode dispatchEventMode = TypeDispatchEventMode.ValueChange ) : this()
		{
			_value = value;
			_dispatchEventMode = dispatchEventMode;
		}

		public NotifierProperty( T value, object sender, TypeDispatchEventMode dispatchEventMode = TypeDispatchEventMode.ValueChange ) : this( value )
		{
			_sender = sender;
			_dispatchEventMode = dispatchEventMode;
		}
		...
		public static implicit operator T( NotifierProperty< T > value )
		{
