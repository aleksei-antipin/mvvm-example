...
{
	public class NotifierList< T > : IList< T >, INotifierListReadOnly< T >
	{
		...
		private NotifierListRemoveRangeArgs< T > _onRemoveRangeArgs;
		private NotifierListSortingArgs< T > _onSortingArgs;
		#endregion
		...
		#region Constructors
		public NotifierList() : this( 0, null )
		{
		}

		public NotifierList( object sender ) : this( 0, sender )
		{
		}

		public NotifierList( int count ) : this( count, null )
		{
		}

		public NotifierList( int count, object sender )
		{
			...
			_onSortingArgs = new NotifierListSortingArgs< T >();
		...
		public event EventHandler< NotifierListSortingArgs< T > > OnSort;
